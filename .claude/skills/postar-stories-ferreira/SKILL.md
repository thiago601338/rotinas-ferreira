...
| "a busca de música 'fashion' não trouxe nenhuma faixa" | Nada foi publicado. Ver o print `busca_musica_*` do resultado; se a busca do Instagram mudou, registrar em `conhecimento/stories.md` e pedir `testar.bat stories-ensaio --sintetico` depois do ajuste. |
